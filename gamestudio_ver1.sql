...
/*Creating tables:*/
create table game(id_game int PRIMARY KEY, game_name varchar(50) not null unique, autor varchar(100) not null, datum_pridania date not null, url_hry varchar(200) not null unique);

create table pouzivatel(id_user int primary key, user_name varchar(50) not null unique, user_pass varchar (8) not null, email varchar (50) not null unique, datum_registracie date not null);
...
insert into game (id_game, game_name, autor, datum_pridania, url_hry) values (idgame.nextval, 'minesweeper', 'Karèi Klešèinský', '28/06/2016', 'www.minesweeper.com');
insert into game (id_game, game_name, autor, datum_pridania, url_hry) values (idgame.nextval, 'DooM', 'Slavomír Barila', '28/05/2016', 'www.doom.com');
insert into game (id_game, game_name, autor, datum_pridania, url_hry) values (idgame.nextval, 'WoW', 'Jozef Ulièný', '28/09/2016', 'www.worldofwarcraft.com');
insert into game (id_game, game_name, autor, datum_pridania, url_hry) values (idgame.nextval, 'Solitare', 'Dalibor Adamèík', '28/08/2016', 'www.solitare.com');
insert into game (id_game, game_name, autor, datum_pridania, url_hry) values (idgame.nextval, 'Bomberman', 'Janko Fazu¾a', '28/07/2016', 'www.bomberman.com');
/*select * from game;*/

insert into pouzivatel (id_user, user_name, user_pass, email, DATUM_REGISTRACIE) values (iduser.nextval, 'Peter Pavol', '12345678', 'peter.pavol@gmail.com', '01/01/2001');
insert into pouzivatel (id_user, user_name, user_pass, email, DATUM_REGISTRACIE) values (iduser.nextval, 'nerty', '23456789', 'nejakyemail@gmail.com', '01/02/2001');
insert into pouzivatel (id_user, user_name, user_pass, email, DATUM_REGISTRACIE) values (iduser.nextval, 'neluska', '55555', 'r4d1k@gmail.com', '01/03/2001');
...
CREATE INDEX ix_score ON score (id_score, score);
